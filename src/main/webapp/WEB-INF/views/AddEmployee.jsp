...
<script src="./resources/js/attachmentFunctions.js"></script>
</head>
<body>
	...
	<div class="container mt-3">
		...
		<form:form action="insertEmployee" method="post" modelAttribute="insertEmployee" enctype="multipart/form-data">
			...
			<jsp:include page="editAttachmentsPanel.jsp"></jsp:include>
